                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className='border border-slate-900 sticky top-0 left-[300px] bg-slate-50'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - SALDO AWAL]
                                </td>
                                <td className='border border-slate-900'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - REALISASI BELANJA]
                                </td>
                                <td className='border border-slate-900'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - HUTANG KEGIATAN 2023]
                                </td>
                                <td className='border border-slate-900'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - ATRIBUSI]
                                </td>
                                <td className='border border-slate-900'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - ~]
                                </td>
                                <td className='border border-slate-900'>
                                    Rp. 0
                                    [KIB_A, KIB_B, KIB_C, KIB_D, KIB_E, KDP - ~]
