    ...
    return (
        <>
                                                    ...
                                                    {data?.type === 'target-kinerja' && (
                                                        <>
                                                            ...
                                                            <div className="cursor-pointer"
                                                                ...
                                                                <FontAwesomeIcon icon={faExclamationCircle} className='text-sky-500 w-3 h-3' />
                                                            </div>
                                                        </>
                                                    )}
            ...
            <Transition appear show={modalDetail} as={Fragment}>
                <Dialog as="div" open={modalDetail} onClose={() => setModalDetail(false)}>
                    <Transition.Child
                        as={Fragment}
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <th className="whitespace-nowrap text-left">
                                                                : {modalDetailData.jenis_transaksi}
                                                            </th>
                                                        </tr>
                                                    </tbody>
                                                </table>
