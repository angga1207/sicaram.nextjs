...
const BerkasPendukung = ({
    ...
    return (
        <div>
            <div className="sticky top-0 left-0 bg-white dark:bg-slate-900 z-10 border-b border-slate-200 dark:border-slate-700 py-2 px-4 pt-5 flex items-center justify-between">
            ...
            <div className="mt-5">
                <div className="space-y-5">
                    {arrRekening?.map((kodeRekening: any, index: number) => (
