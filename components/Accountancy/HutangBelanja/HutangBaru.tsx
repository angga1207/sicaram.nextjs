...
const HutangBaru = (param: any) => {
    ...
    const _getData = () => {
        if (periode?.id) {
            getHutangBaru(instance, periode?.id, year).then((res: any) => {
    ...
    const updatedData = (data: any, index: number) => {
        setDataInput((prev: any) => {
            const updated = [...prev];
            updated[index].jumlah_pembayaran_hutang = parseFloat(updated[index].p1_jumlah) + parseFloat(updated[index].p2_jumlah) + parseFloat(updated[index].p3_jumlah) + parseFloat(updated[index].p4_jumlah);
    ...
    useEffect(() => {
        if (isMounted && dataInput.length > 0) {
            setTotalData((prev: any) => {
                ...
                updated.p4_jumlah = dataInput.reduce((acc: any, obj: any) => acc + parseFloat(obj['p4_jumlah']), 0);
    ...
    const save = () => {
        ...
        storeHutangBaru(dataInput, periode?.id, year).then((res: any) => {
    ...
    const _deleteData = (id: any) => {
        deleteHutangBaru(id).then((res: any) => {
            if (res.status == 'success') {
                _getData();
    ...
    const deleteSelectedData = () => {
        massDeleteData(selectedData, 'acc_htb_hutang_baru').then((res: any) => {
            if (res.status == 'success') {
                _getData();
                setSelectedData([]);
                                            ...
                                            <tr className=''>
                                                ...
                                                <td className='border'>
                                                    <input type="text"
                                                        placeholder='No SP2D'
                                                        autoComplete='off'
                                                        value={data.p4_nomor_sp2d}
                                                        onChange={(e) => {
                                                            setDataInput((prev: any) => {
                                                                const updated = [...prev];
                                                                updated[index]['p4_nomor_sp2d'] = e.target.value;
                                                                return updated;
                                                            });
                                                        }}
                                                        className='form-input font-normal min-w-[250px]' />
                                                ...
                                                <td className='border'>
                                                    <Flatpickr
                                                        ...
                                                        onChange={(date) => {
                                                            ...
                                                            setDataInput((prev: any) => {
                                                                const updated = [...prev];
                                                                updated[index]['p4_tanggal'] = newYmd;
                                                                return updated;
                                                            })
                                                            setIsUnsaved(true);
                                                        }} />
                                                ...
                                                <td className='border'>
                                                    <InputRupiah
                                                        // readOnly={true}
                                                        dataValue={data.p4_jumlah}
                                                        onChange={(value: any) => {
                                                            setDataInput((prev: any) => {
                                                                const updated = [...prev];
                                                                updated[index]['p4_jumlah'] = isNaN(value) ? 0 : value;
                                                                updatedData(updated, index);
                                                                return updated;
                                                            });
                                                        }} />
                                                ...
                                                <td className='border'>
                                                    <Tippy content="= (Pembayaran Ke - 1) + (Pembayaran Ke - 2) + (Pembayaran Ke - 3) + (Pembayaran Ke - 4)" placement='top'>
                                                ...
                                                <td className='border'>
                                                    <Tippy content="= Nilai Kontrak - Jumlah Pembayaran Hutang" placement='top'>
                                                        <div className='cursor-pointer'>
                                                            <InputRupiah
                                                                readOnly={true}
                            ...
                            <tr>
                                ...
                                <td className='bg-slate-200 border p-4'>
                                    <div className="flex justify-between font-semibold">
                                        Rp.
                                        <div>
                                            {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(totalData.p4_jumlah)}
                                        </div>
                                    </div>
                                </td>
                                <td className='bg-slate-200 border p-4'>
