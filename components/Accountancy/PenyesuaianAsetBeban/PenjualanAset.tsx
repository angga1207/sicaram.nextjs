                                    ...
                                    <td className="border">
                                        <div className="flex group">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    setDataInput((prev: any) => {
                                                        ...
                                                        const data = [...prev];
                                                        data[index].harga_perolehan = isNaN(value) ? 0 : value;
                                                        updatedData1(data, index);
                                                        return data;
                                                    });
                                                }}
                                            ...
                                            <div className="form-input w-[250px] ltr:rounded-l-none rtl:rounded-r-none font-semibold text-end block group-focus-within:hidden group-hover:hidden">
                                                {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 0 }).format(data.harga_perolehan)}
                                            </div>
                                        </div>
                                    </td>
                                    <td className="border">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    setDataInput((prev: any) => {
                                                        const value = parseFloat(e?.target?.value);
                                                        const data = [...prev];
                                                        data[index].harga_jual = isNaN(value) ? 0 : value;
                                                        updatedData1(data, index);
                                                        return data;
                                                    });
                                                }}
                                                className="form-input w-[250px] ltr:rounded-l-none rtl:rounded-r-none font-semibold text-end hidden group-focus-within:block group-hover:block" />
                                            <div className="form-input w-[250px] ltr:rounded-l-none rtl:rounded-r-none font-semibold text-end block group-focus-within:hidden group-hover:hidden">
                                                {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 0 }).format(data.harga_jual)}
                                            </div>
                                        </div>
                                    </td>
                                    <td className="border">
                                            ...
                                            {/* <input
                                                ...
                                                onChange={(e) => {
                                                    setDataInput((prev: any) => {
                                                        const value = parseFloat(e?.target?.value);
                                                        const data = [...prev];
                                                        data[index].surplus = isNaN(value) ? 0 : value;
                                                        return data;
                                                    });
                                                }}
                                                className="form-input w-[250px] ltr:rounded-l-none rtl:rounded-r-none font-semibold text-end hidden group-focus-within:block group-hover:block" /> */}
                                            <div className="form-input w-[250px] ltr:rounded-l-none rtl:rounded-r-none font-semibold text-end bg-slate-100">
                                                {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 0 }).format(data.surplus)}
                                            </div>
                                        </div>
                                    </td>
                                    <td className='border'>
