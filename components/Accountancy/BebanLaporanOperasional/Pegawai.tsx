...
import { calculateData, deletePegawai, getPegawai, storePegawai } from '@/apis/Accountancy/BebanLaporanOperasional';
...
const Pegawai = (data: any) => {
    ...
    const deleteSelectedData = () => {
        massDeleteData(selectedData, 'acc_blo_pegawai').then((res: any) => {
            if (res.status == 'success') {
                _getDatas();
                setSelectedData([]);
    ...
    const handleCalculate = () => {
        ...
        calculateData(periode?.id, year, 'pegawai').then((res: any) => {
            if (res.status == 'success') {
