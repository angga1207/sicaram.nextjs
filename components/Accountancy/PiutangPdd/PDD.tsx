...
import { deletePdd, getPdd, storePdd } from '@/apis/Accountancy/PiutangPdd';
...
const PDD = (data: any) => {
    ...
    const _getDatas = (instanceId: any, tahun: any) => {
        if (periode?.id) {
            getPdd(instanceId, periode?.id, tahun).then((res: any) => {
                        ...
                        setDataInput1([
                            {
                                ...
                                kode_rekening_id: '',
                                pendapatan_diterima_dimuka_awal: 0,
                                mutasi_berkurang: 0,
                                mutasi_bertambah: 0,
                                pendapatan_diterima_dimuka_akhir: 0,
                            }
                        ])
                        setDataInput2([
                            {
        ...
        if (data.length > 0 && data[0]) {
            if (data[0].type == 'pendapatan_pajak_daerah') {
                setDataInput1((prev: any) => {
                    ...
                    updated[index]['mutasi_bertambah'] = parseFloat(updated[index]['pendapatan_diterima_dimuka_awal']);
                    updated[index]['pendapatan_diterima_dimuka_akhir'] = parseFloat(updated[index]['mutasi_berkurang']) + parseFloat(updated[index]['pendapatan_diterima_dimuka_awal']) - parseFloat(updated[index]['mutasi_bertambah']);
    ...
    useEffect(() => {
        if (isMounted) {
            setTotalData((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = parseFloat(totalData1['pendapatan_diterima_dimuka_awal'] ?? 0) + parseFloat(totalData2['pendapatan_diterima_dimuka_awal'] ?? 0) + parseFloat(totalData3['pendapatan_diterima_dimuka_awal'] ?? 0) + parseFloat(totalData4['pendapatan_diterima_dimuka_awal'] ?? 0) + parseFloat(totalData5['pendapatan_diterima_dimuka_awal'] ?? 0) + parseFloat(totalData6['pendapatan_diterima_dimuka_awal'] ?? 0);

                updated['mutasi_berkurang'] = parseFloat(totalData1['mutasi_berkurang'] ?? 0) + parseFloat(totalData2['mutasi_berkurang'] ?? 0) + parseFloat(totalData3['mutasi_berkurang'] ?? 0) + parseFloat(totalData4['mutasi_berkurang'] ?? 0) + parseFloat(totalData5['mutasi_berkurang'] ?? 0) + parseFloat(totalData6['mutasi_berkurang'] ?? 0);

                updated['mutasi_bertambah'] = parseFloat(totalData1['mutasi_bertambah'] ?? 0) + parseFloat(totalData2['mutasi_bertambah'] ?? 0) + parseFloat(totalData3['mutasi_bertambah'] ?? 0) + parseFloat(totalData4['mutasi_bertambah'] ?? 0) + parseFloat(totalData5['mutasi_bertambah'] ?? 0) + parseFloat(totalData6['mutasi_bertambah'] ?? 0);

                updated['pendapatan_diterima_dimuka_akhir'] = parseFloat(totalData1['pendapatan_diterima_dimuka_akhir'] ?? 0) + parseFloat(totalData2['pendapatan_diterima_dimuka_akhir'] ?? 0) + parseFloat(totalData3['pendapatan_diterima_dimuka_akhir'] ?? 0) + parseFloat(totalData4['pendapatan_diterima_dimuka_akhir'] ?? 0) + parseFloat(totalData5['pendapatan_diterima_dimuka_akhir'] ?? 0) + parseFloat(totalData6['pendapatan_diterima_dimuka_akhir'] ?? 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput1.length > 0) {
            setTotalData1((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput1.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput1.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput1.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput1.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput2.length > 0) {
            setTotalData2((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput2.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput2.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput2.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput2.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput3.length > 0) {
            setTotalData3((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput3.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput3.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput3.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput3.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput4.length > 0) {
            setTotalData4((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput4.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput4.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput4.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput4.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput5.length > 0) {
            setTotalData5((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput5.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput5.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput5.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput5.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    useEffect(() => {
        if (isMounted && dataInput6.length > 0) {
            setTotalData6((prev: any) => {
                const updated = { ...prev };
                updated['pendapatan_diterima_dimuka_awal'] = dataInput6.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_awal']), 0);
                updated['mutasi_berkurang'] = dataInput6.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_berkurang']), 0);
                updated['mutasi_bertambah'] = dataInput6.reduce((acc: any, obj: any) => acc + parseFloat(obj['mutasi_bertambah']), 0);
                updated['pendapatan_diterima_dimuka_akhir'] = dataInput6.reduce((acc: any, obj: any) => acc + parseFloat(obj['pendapatan_diterima_dimuka_akhir']), 0);
                return updated;
            })
        }
    ...
    const save = () => {
        ...
        storePdd(MergedDataInput, periode?.id, year).then((res: any) => {
    ...
    const selectAll = () => {
        // Jika sudah semua dipilih, maka hapus semua pilihan
        const datas = dataInput1.concat(dataInput2, dataInput3, dataInput4, dataInput5, dataInput6);
        if (selectedData.length === datas.length) {
            setSelectedData([]);
        } else {
            // Jika belum semua dipilih, maka pilih semua
            const allIds = datas.map((data: any) => data.id);
            setSelectedData(allIds);
        }
    }

    const deleteSelectedData = () => {
        massDeleteData(selectedData, 'acc_plo_pdd').then((res: any) => {
            if (res.status == 'success') {
                _getDatas(instance, year);
                setSelectedData([]);
        ...
        <>
            <div className="table-responsive h-[calc(100vh-400px)] pb-5">
                <table className="table-striped">
                    ...
                    <tbody>
                        {(dataInput1.length > 0 || dataInput2.length > 0 || dataInput3.length > 0 || dataInput4.length > 0 || dataInput5.length > 0 || dataInput6.length > 0) ? (
                            <>
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData1.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData1.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData1.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData1.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                                {dataInput1.map((data: any, index: any) => (
                                    <tr key={index}>
                                        ...
                                        <td className="border">
                                            <InputRupiah
                                                dataValue={data.pendapatan_diterima_dimuka_awal}
                                                onChange={(value: any) => {
                                                    setDataInput1((prev: any) => {
                                                        const updated = [...prev];
                                                        updated[index]['pendapatan_diterima_dimuka_awal'] = isNaN(value) ? 0 : value;
                                        ...
                                        <td className="border">
                                            <InputRupiah
                                                dataValue={data.mutasi_berkurang}
                                                onChange={(value: any) => {
                                                    setDataInput1((prev: any) => {
                                                        const updated = [...prev];
                                                        updated[index]['mutasi_berkurang'] = isNaN(value) ? 0 : value;
                                                        updatedData(updated, index);
                                                        return updated;
                                                    });
                                                }} />
                                        ...
                                        <td className="border">
                                            <InputRupiah
                                                readOnly={true}
                                                dataValue={data.mutasi_bertambah}
                                                onChange={(value: any) => {
                                                    setDataInput1((prev: any) => {
                                                        const updated = [...prev];
                                                        updated[index]['mutasi_bertambah'] = isNaN(value) ? 0 : value;
                                                        updatedData(updated, index);
                                                        return updated;
                                                    });
                                                }} />
                                        ...
                                        <td className="border">
                                            <InputRupiah
                                                readOnly={true}
                                                dataValue={data.pendapatan_diterima_dimuka_akhir}
                                                onChange={(value: any) => {
                                                    setDataInput1((prev: any) => {
                                                        const updated = [...prev];
                                                        updated[index]['pendapatan_diterima_dimuka_akhir'] = isNaN(value) ? 0 : value;
                                                        updatedData(updated, index);
                                                        return updated;
                                                    });
                                                }} />
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData2.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData2.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData2.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData2.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData3.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData3.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData3.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData3.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData4.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData4.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData4.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData4.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData5.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData5.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData5.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData5.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData6.pendapatan_diterima_dimuka_awal}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData6.mutasi_berkurang}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData6.mutasi_bertambah}
                                            readOnly={true} />
                                    </td>
                                    <td className='bg-slate-200/50 border font-semibold'>
                                        <InputRupiah
                                            dataValue={totalData6.pendapatan_diterima_dimuka_akhir}
                                            readOnly={true} />
                                    </td>
                                </tr>
                            ...
                            <tr>
                                ...
                                <td className="border p-4">
                                    <div className="flex justify-between text-end font-semibold whitespace-nowrap">
                                        ...
                                        <div className="">
                                            {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(totalData.pendapatan_diterima_dimuka_awal)}
                                        </div>
                                    </div>
                                </td>
                                <td className="border p-4">
                                    <div className="flex justify-between text-end font-semibold whitespace-nowrap">
                                        ...
                                        <div className="">
                                            {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(totalData.mutasi_berkurang)}
                                        </div>
                                    </div>
                                </td>
                                <td className="border p-4">
                                    <div className="flex justify-between text-end font-semibold whitespace-nowrap">
                                        ...
                                        <div className="">
                                            {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(totalData.mutasi_bertambah)}
                                        </div>
                                    </div>
                                </td>
                                <td className="border p-4">
                                    <div className="flex justify-between text-end font-semibold whitespace-nowrap">
                                        ...
                                        <div className="">
                                            {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(totalData.pendapatan_diterima_dimuka_akhir)}
                                        </div>
                                    </div>
                                </td>
                            </tr>
