...
import { getKDP, saveKDP } from '@/apis/Accountancy/RekonsiliasiAset';
...
const KDP = (data: any) => {
    ...
    const _getDatas = () => {
        getKDP(instance, periode?.id, year).then((res) => {
    ...
    const _saveData = () => {
        setIsSaving(true);
        saveKDP(instance, periode?.id, year, dataInput).then((res) => {
            if (res.status === 'success') {
                setIsUnsaved(false);
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hutang Belanja (Konstruksi Dalam Pekerjaan)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Atribusi Penyesuaian Aset dan Beban (Konstruksi Dalam Pekerjaan)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hibah Masuk di Penyesuaian Aset dan Beban (Konstruksi Dalam Pekerjaan)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Penilaian Aset di Penyesuaian Aset dan Beban (Konstruksi Dalam Pekerjaan)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Mutasi Aset di Penyesuaian Aset dan Beban (Konstruksi Dalam Pekerjaan)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
