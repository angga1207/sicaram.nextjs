                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hutang Belanja (Aset Tetap Peralatan & Mesin)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Atribusi Penyesuaian Aset dan Beban (Aset Tetap Peralatan & Mesin)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hibah Masuk di Penyesuaian Aset dan Beban (Aset Tetap Peralatan & Mesin)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Penilaian Aset di Penyesuaian Aset dan Beban (Aset Tetap Peralatan & Mesin)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Mutasi Aset di Penyesuaian Aset dan Beban (Aset Tetap Peralatan & Mesin)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
