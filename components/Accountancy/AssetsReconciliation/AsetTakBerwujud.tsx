...
import { getAsetTakBerwujud, saveAsetTakBerwujud } from '@/apis/Accountancy/RekonsiliasiAset';
...
const AsetTakBerwujud = (data: any) => {
    ...
    const _getDatas = () => {
        getAsetTakBerwujud(instance, periode?.id, year).then((res) => {
    ...
    const _saveData = () => {
        setIsSaving(true);
        saveAsetTakBerwujud(instance, periode?.id, year, dataInput).then((res) => {
            if (res.status === 'success') {
                setIsUnsaved(false);
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hutang Belanja (Aset Lainnya)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Atribusi Penyesuaian Aset dan Beban (Aset Lainnya)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Hibah Masuk di Penyesuaian Aset dan Beban (Aset Lainnya)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Penilaian Aset di Penyesuaian Aset dan Beban (Aset Lainnya)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
                                            ...
                                            <td className='border border-slate-900'>
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Tippy
                                                        content='Dari Mutasi Aset di Penyesuaian Aset dan Beban (Aset Lainnya)'
                                                        theme='info'
                                                    >
                                                        <FontAwesomeIcon
                                                            icon={faExclamationCircle}
...
export default AsetTakBerwujud;
