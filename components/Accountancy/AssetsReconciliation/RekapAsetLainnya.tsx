...
import { getRekapAsetLainnya, saveRekapAsetLainnya } from '@/apis/Accountancy/RekonsiliasiAset';
...
const RekapAsetLainnya = (data: any) => {
    ...
    const _getDatas = () => {
        setIsLoading(true);
        getRekapAsetLainnya(instance, periode?.id, year).then((res) => {
    ...
    const _saveData = () => {
        setIsSaving(true);
        saveRekapAsetLainnya(instance, periode?.id, year, dataInput).then((res) => {
            if (res.status === 'success') {
                setIsUnsaved(false);
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td className='border border-slate-900'>
                                                        ...
                                                        <div className="form-input bg-slate-200 text-end font-normal ltr:rounded-l-none rtl:rounded-r-none">
                                                        ...
                                                        <div className="ml-1 self-center">
                                                            <Tippy content="Link Penghapusan Aset & Penjualan Aset" theme="bct" className="p-2">
                                                                <Link href="/accountancy/penyesuaian-aset-beban?app=7" className="btn btn-primary h-9 rounded-full w-9 px-2">
                                                                    <FontAwesomeIcon icon={faLink} className="h-4 w-4 cursor-pointer" />
                                                                </Link>
                                                            </Tippy>
                                                        </div>
                                                    </div> */}
                    ...
                    <div className="flex justify-end gap-2 items-center">
                        {dataInput.length > 0 && (
                            <DownloadButtons
                                ...
                                params={{
                                    type: 'rekon_aset_rekap_aset_lainnya',
                                    category: 'kibs',
                                    instance: instance,
                                    periode: periode?.id,
                                    year: year,
...
export default RekapAsetLainnya;
