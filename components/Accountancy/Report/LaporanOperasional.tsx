...
import { downloadReportLaporanOperasional, getReportLaporanOperasional, saveSingleLaporanOperasional } from '@/apis/Accountancy/Report';
...
const LaporanOperasional = (data: any) => {
    ...
    const updatedData = (data: any, index: number) => {
        setDatas((prev: any) => {
            ...
            if (currentData.code_3 !== null) {
                ...
                updated[parentIndex].saldo_akhir = updated.filter((item: any) => (currentData.code_1 === item.code_1) && (currentData.code_2 === item.code_2) && (item.code_3 !== null) && (item.code_4 !== null) && (item.code_5 !== null) && (item.code_6 !== null)).reduce((acc: any, item: any) => acc + parseFloat(item.saldo_akhir), 0);
            }
            if (currentData.code_2 !== null) {
                const parentIndex = updated.findIndex((item: any) => (currentData.code_1 === item.code_1) && (item.code_2 === null));
                updated[parentIndex].saldo_akhir = updated.filter((item: any) => (currentData.code_1 === item.code_1) && (item.code_2 !== null) && (item.code_3 !== null) && (item.code_4 !== null) && (item.code_5 !== null) && (item.code_6 !== null)).reduce((acc: any, item: any) => acc + parseFloat(item.saldo_akhir), 0);
            }
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className='text-center'>
                                                ...
                                                <InputRupiahSingleSave
                                                    readOnly={data.code_6 !== null ? !instance ? true : false : true}
                                                    ...
                                                    onSave={() => {
                                                        ...
                                                        if (isUnsaved) {
                                                            saveSingleLaporanOperasional(data).then((res) => {
                                                                if (res.status === 'error') {
                                                                    showAlert('error', 'Terjadi kesalahan');
                                                                }
                                                                else if (res.status === 'success') {
                                            ...
                                            <td>
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="">
                                                        {new Intl.NumberFormat('id-ID', { minimumFractionDigits: 2 }).format(data.saldo_akhir - data.saldo_awal)}
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
