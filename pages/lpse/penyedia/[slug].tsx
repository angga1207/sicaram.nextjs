...
const Page = () => {
    ...
    const fetchData = async (slug: any) => {
        if (slug) {
            ...
            const res = await axios.get(`${baseUri}/lpse/getPenyediaTerumumkan/${slug}`, {
                headers: {
    ...
    const fetchDetail = async (kd_rup: any) => {
        const res = await axios.get(`${baseUri}/lpse/getPenyediaTerumumkan/${slug}/${kd_rup}`, {
            headers: {
                'Content-Type': 'application/json',
                Authorization: `Bearer ${CurrentToken}`,
            },
                ...
                <div className="flex flex-col lg:flex-row gap-y-5 lg:items-center lg:justify-between">
                    <div className="">
                        <h2 className="text-xl font-semibold">
                            Daftar Paket Penyedia Terumumkan Tahun {year}
                        </h2>
                    ...
                    <div className="self-end flex items-center gap-2">
                        ...
                        <Link href={`/lpse/penyedia?year=${year}`}>
                                                            ...
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    <div
                                                                        ...
                                                                        {detail?.penyedia?.urarian_pekerjaan}
                                                                    </div>

                                                                    {detail?.penyedia?.urarian_pekerjaan.length > 1000 && (
                                                            ...
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    <div
                                                                        ...
                                                                        className={`${spesifikasiPekerjaanLong ? 'cursor-pointer' : 'line-clamp-5'}`}>
                                                                        {detail?.penyedia?.spesifikasi_pekerjaan}
                                                                    </div>

                                                                    {detail?.penyedia?.spesifikasi_pekerjaan.length > 1000 && (
                                                                        <div className="mt-1 text-end">
                                                                            <div className="text-blue-500 cursor-pointer text-xs"
                                                                                onClick={() => {
                                                                                    setSpesifikasiPekerjaanLong(!spesifikasiPekerjaanLong)
                                                                                    setUraianPekerjaanLong(false)
                                                                                }}>
                                                                                {spesifikasiPekerjaanLong ? 'Sembunyikan' : 'Lihat Selengkapnya'}
                                                                            </div>
                                                                        </div>
                                                                    )}
                                                                </>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    <div className="flex">
                                                                        <div className={`badge rounded-full font-semibold ${detail?.penyedia?.status_pdn == 'PDN' ? 'bg-success' : 'bg-primary'}`}>
                                                                            {detail?.penyedia?.status_pdn == 'PDN' ? 'Ya' : 'Tidak'}
                                                                        </div>
                                                                    </div>
                                                                </>
                                                            )}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    <div className="flex">
                                                                        <div className={`badge rounded-full font-semibold ${detail?.penyedia?.status_ukm == 'UKM' ? 'bg-success' : 'bg-primary'}`}>
                                                                            {detail?.penyedia?.status_ukm == 'UKM' ? 'Ya' : 'Tidak'}
                                                                        </div>
                                                                    </div>
                                                                </>
                                                            )}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    <div className="flex">
                                                                        <div className={`badge rounded-full font-semibold ${detail?.penyedia?.status_pradipa == 'Non-PraDIPA' ? 'bg-success' : 'bg-primary'}`}>
                                                                            {detail?.penyedia?.status_pradipa == 'Non-PraDIPA' ? 'Ya' : 'Tidak'}
                                                                        </div>
                                                                    </div>
                                                                </>
                                                            )}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    {detail?.penyedia?.jenis_pengadaan}
                                                                </>
                                                            )}
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {isLoadingDetail ? (
                                                                ...
                                                                <>
                                                                    {detail?.penyedia?.metode_pengadaan}
                                                                </>
                                                            )}
                                                        </td>
                                                    </tr>
                                                                    ...
                                                                    <div className="flex items-center gap-2 w-full">
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_awal_pemanfaatan).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            <div className="border-b border-dashed pb-1 text-xs text-slate-400">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_akhir_pemanfaatan).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </>
                                                                ...
                                                                <>
                                                                    <div className="flex items-center gap-2 w-full">
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_awal_kontrak).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            <div className="border-b border-dashed pb-1 text-xs text-slate-400">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_akhir_kontrak).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </>
                                                                ...
                                                                <>
                                                                    <div className="flex items-center gap-2 w-full">
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_awal_pemilihan).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                        <div className="w-1/2 px-2 flex flex-col gap-1">
                                                                            <div className="border-b border-dashed pb-1 text-xs text-slate-400">
                                                                            ...
                                                                            <div className="font-semibold">
                                                                                {new Date(detail?.penyedia?.tgl_akhir_pemilihan).toLocaleString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </>
