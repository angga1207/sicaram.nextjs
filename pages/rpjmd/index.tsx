        ...
        Object.keys(data.indikator).map((year: any, index: any) => {
            data.indikator?.[year]?.map((item: any, i: any) => {
                if (item.name == '') {
                    ...
                    invalidType = 'name';
                    document.getElementById('error-name-' + year + '-' + i).innerHTML = invalidMessage ?? '';
                }
                if (item.value == '') {
                    valid = false;
                    invalidIndex = i;
                    ...
                    invalidType = 'value';
                    document.getElementById('error-value-' + year + '-' + i).innerHTML = invalidMessage ?? '';
                }
                if (item.satuan_id == '') {
                    valid = false;
                    invalidIndex = i;
                    ...
                    document.getElementById('error-satuan-' + year + '-' + i).innerHTML = invalidMessage ?? '';
                }
            });
        });
                                                            ...
                                                            <table className="table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    {indicators?.[year] && typeof indicators?.[year] == 'object' && (
                                                                        <>
                                                                            {indicators?.[year]?.map((data, index) => {
                                                                                return (
                                                                                    <>
                                                                                        <tr key={data?.id}>
                                                                                            <td>
