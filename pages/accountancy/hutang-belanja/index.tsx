                        ...
                        <table className="table-striped">
                            <thead>
                                <tr className='!bg-dark !text-white'>
                                    ...
                                    <th rowSpan={3} className='sticky left-0 top-0 bg-dark text-white text-center border border-slate-100 whitespace-nowrap'>
                                ...
                                {dataInput.map((data: any, index: number) => (
                                    <Fragment key={index}>
                                        <tr className=''>
                                            ...
                                            <td className='sticky left-0 bg-slate-50 border'>
                                                <div className="flex items-center gap-2">
                                                    <input type="text"
