...
import BarangHabisPakai from '@/components/Accountancy/Persediaan/BarangHabisPakai';
import Rekap from '@/components/Accountancy/Persediaan/Rekap';
import BelanjaPersediaanUntukDijual from '@/components/Accountancy/Persediaan/BelanjaPersediaanUntukDijual';
import NilaiPersediaanNeraca from '@/components/Accountancy/Persediaan/NilaiPersediaanNeraca';
...
const Page = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Persediaan'));
    });
